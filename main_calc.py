...
class CalculatorApp(App):
	...
	def build(self):
		...
		bl.add_widget(Button(text="(a*b)mod c(введите 3 числа через пробел)", size_hint = (None,None) ,size = (350,40)))
		bl.add_widget(Button(text="n-1", size_hint = (None,None) ,size = (350,40)))
